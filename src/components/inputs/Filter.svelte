<script lang="ts">
    ...
    let {
        placeholder = "Explore in guardian",
        name = "search",
        value = $bindable(""),
        onChange
    }: Props = $props();
...
<style>
    ...
    overflow: hidden;
    border-radius: 10px;
    background: linear-gradient(180deg, #050924, #01012b, #0066cc);
